  ...
  return (
    <>
      ...
      <section className="pt-[161px] max-md:py-20 max-bigscreen:px-[80px] max-md:px-[40px] max-sm:px-[20px]  relative pb-[229px] pl-[172px] pr-[80px] flex justify-between max-hamburger:flex-col max-xl:gap-[50px] items-center">
        <div className="bg-[#1BC45E] max-md:w-full max-md:left-0 blur-[256px] w-[403px] z-10 h-[300px] left-[140px] top-[171px] absolute rounded-[100%] z-[2]"></div>
        <div
          className={`px-[18px] relative card w-[413px] max-md:w-full max-smalllaptop:w-[48.3%] border-white rounded-[10px] py-[20px] ${style.aicardborder}`}
        >
          <div className="bg-black rounded-[9px]">
            ...
            >
              ...
              <div className="flex relative z-20 justify-between mt-[49px]">
